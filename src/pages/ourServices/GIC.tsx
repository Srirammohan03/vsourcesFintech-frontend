...
export default function GIC() {
  return (
    <section className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 text-gray-900">
      {/* Hero Section */}
      <div className="bg-gradient-to-b from-[#002855] to-[#1a1a1a] text-white pt-32 pb-16 px-6 text-center">
        <Currency className="mx-auto mb-4 w-14 h-14 animate-pulse" />
      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 py-10">
        <h2 className="text-xl md:text-3xl font-bold mb-8 text-center text-black">What is a Guaranteed Investment Certificate (GIC)?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-10 text-center">
          {[
            ...
            {
              icon: <UserCheck className="w-12 h-12 text-red-600 mx-auto mb-4" />,
            ...
            {
              icon: <Currency className="w-12 h-12 text-red-600 mx-auto mb-4" />,
        ...
        <div className="w-full max-w-[1400px] mx-auto px-6 py-10">
          <h3 className="text-2xl font-bold mb-6 text-black text-center">GIC Requirements by Country</h3>
