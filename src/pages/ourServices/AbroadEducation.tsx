...
const features = [
    ...
    },
    {
        ...
        description: "Our platform helps you compare competitive interest rates from different lenders, ensuring you get the most affordable loan possible. A lower interest rate means you'll pay less over the life of your loan. We provide transparent comparisons of rates and fees from multiple lenders, giving you the power to choose a loan that won't burden you with excessive long-term costs.",
        icon: <CreditCard className="h-8 w-8 text-red-600" />,
        image: "/assets/images/CompetitiveRates.jpg",
    },
    {
        title: "Post-Loan Support",
        description: "Our support doesn't end when the loan is disbursed. We're here to help you with any questions or issues that arise throughout your studies. Your relationship with us continues long after you've received your funds. Whether you have questions about your repayment schedule, need to understand your loan terms better, or face an unexpected financial issue, our support team is just a call or message away, ready to assist you throughout your academic journey.",
                ...
                <div className="w-full max-w-[1400px] mx-auto px-6">
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
                            The cost of educational institutions abroad is rising day by day, and securing a loan is a smart move to manage your finances and focus on your studies.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <h3 className="text-xl font-bold text-center text-gray-800 mb-2">Manage Rising Costs</h3>
                            <p className="text-gray-600 text-center">
                                The costs of tuition, accommodation, and living expenses abroad can be overwhelming. An education loan provides a comprehensive financial safety net.
                            </p>
                        </div>
                        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                            <div className="flex items-center justify-center mb-4">
                                <div className="bg-purple-100 p-3 rounded-full text-red-600 shadow-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                                </div>
                            </div>
                            <h3 className="text-xl font-bold text-center text-gray-800 mb-2">Comprehensive Funding</h3>
                            <p className="text-gray-600 text-center">
                                Loans often cover more than just tuition, including books, travel, and living expenses, ensuring you're fully prepared for your journey.
                            </p>
                        </div>
                        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                            <div className="flex items-center justify-center mb-4">
                            ...
                            <h3 className="text-xl font-bold text-center text-gray-800 mb-2">Ease Your Family's Burden</h3>
                            <p className="text-gray-600 text-center">
                                Taking a loan can alleviate the financial strain on your parents, allowing you to take full ownership of your educational journey.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full max-w-[1400px] mx-auto px-6 ">
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                            An education loan is more than just a financial tool; it's an investment in your future that offers numerous benefits beyond just covering costs.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start p-6 rounded-lg bg-gray-50 border border-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                            <div className="flex-shrink-0">
                                ...
                                <img src="/assets/images/Financial-Independence.gif" alt="Financial Independence" />
                            </div>
                            <div className="ml-0 sm:ml-6 mt-4 sm:mt-0 text-center sm:text-left">
                                <h3 className="text-xl font-bold text-gray-800">Financial Independence</h3>
                                <p className="mt-2 text-gray-600">
                                    Support your education without burdening your parents' financial situation, giving you a sense of ownership and responsibility.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start p-6 rounded-lg bg-gray-50 border border-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                            <div className="flex-shrink-0">
                                ...
                                <img src="/assets/images/CoverAllYourNeeds.gif" alt="CoverAllYourNeeds" />

                            </div>
                            <div className="ml-0 sm:ml-6 mt-4 sm:mt-0 text-center sm:text-left">
                                <h3 className="text-xl font-bold text-gray-800">Cover All Your Needs</h3>
                                <p className="mt-2 text-gray-600">
                                    A student loan helps cover not just tuition fees but also living expenses, books, and travel, so you can focus on your studies.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start p-6 rounded-lg bg-gray-50 border border-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                            <div className="flex-shrink-0">
                                ...
                                <img src="/assets/images/Flexible-Repayment.gif" alt="Flexible-Repayment" />

                            </div>
                            <div className="ml-0 sm:ml-6 mt-4 sm:mt-0 text-center sm:text-left">
                                <h3 className="text-xl font-bold text-gray-800">Flexible Repayment Options</h3>
                                <p className="mt-2 text-gray-600">
                                    Benefit from flexible repayment plans that often begin after you have graduated and found employment, giving you peace of mind.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start p-6 rounded-lg bg-gray-50 border border-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                            <div className="flex-shrink-0">
                                ...
                                <img src="/assets/images/Financial-Discipline.gif" alt="Build-Financial-Discipline" />
                            </div>
                            <div className="ml-0 sm:ml-6 mt-4 sm:mt-0 text-center sm:text-left">
                                <h3 className="text-xl font-bold text-gray-800">Build Financial Discipline</h3>
                                <p className="mt-2 text-gray-600">
                                    Taking on and managing a loan responsibly helps you build a strong credit history and develop financial discipline for the future.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-10 bg-gray-50">
                <div className="w-full max-w-[1400px] mx-auto px-6">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                            We offer a tailored approach to secure your education loan, ensuring you
                            have the support and resources you need for your academic journey.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row bg-white rounded-2xl shadow-xl overflow-hidden">
                        ...
                        <div className="w-full md:w-1/3 p-6 bg-blue-600 flex flex-col space-y-3">
                            <h2 className="text-2xl font-bold text-white mb-4">Our Features</h2>
