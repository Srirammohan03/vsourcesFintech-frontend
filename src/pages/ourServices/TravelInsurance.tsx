...
export default function TravelInsurance() {
  ...
  const handlePrevSlide = () => {
    setCurrentSlide(
      (prevSlide) => (prevSlide - 1 + planSlides.length) % planSlides.length
    );
  };
      ...
      <section className="relative text-white pt-32 pb-10 lg:pt-40 lg:pb-32">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 flex flex-col items-center md:items-start justify-center text-left">
          ...
          <p className="text-white max-w-2xl">
            Travel Insurance for students planning to study abroad is a
            protection plan which covers costs if you fall sick, lose your bags,
            or if your flight gets delayed or cancelled. VSource helps Indian
            students offers customised insurance plans from multiple insurance
            providers for students who are going to study abroad. We make it
            easy to get travel insurance with affordable plans and customised
            support.
          </p>
        </div>
      </section>
