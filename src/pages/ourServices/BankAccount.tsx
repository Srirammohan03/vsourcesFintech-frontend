...
const typesOfAccounts = [
    ...
    },
    {
        ...
        icon: <FaGlobeAmericas className="text-red-600 w-10 h-10 md:w-10 md:h-10" />,
    },
    {
...
const topBanksData = [
    ...
    },
    {
        country: "Ireland",
        bgImage:
            "/assets/images/ireland-bank.jpg",
        banks: [
            { name: "Allied Irish Bank Student Account", iconKey: "Allied Irish Bank" },
    ...
    },
    {
        country: "Australia",
        bgImage:
            "/assets/images/Australia-bank.jpg",
        banks: [
            { name: "Commonwealth Bank Student Account", iconKey: "Commonwealth Bank" },
    ...
    },
    {
        country: "Germany",
        bgImage:
            "/assets/images/Germany-bank.jpg",
        banks: [
...
const BankAccount: React.FC = () => {
    ...
    return (
        <div className="">
            ...
            >
                ...
                <div className="max-w-xl mx-auto text-center mb-12">
                    ...
                    <p className="text-black text-lg leading-relaxed">
                        Having a local bank account in your study destination simplifies your financial life,
                        saves money, and opens doors to many benefits designed especially for international students.
                    </p>
                </div>
                ...
                <p className="mt-7 text-center italic text-gray-500 font-medium max-w-3xl mx-auto">
                    Opening a local bank account is one of the smartest steps to confidently manage your finances and stay financially empowered while you study abroad.
                </p>
            </motion.section>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    {typesOfAccounts.map(({ type, idealFor, features, icon }) => (
                        ...
                        >
                            <div className="flex items-start space-x-3 mb-4">{icon}
                                    ...
                                    <ul className="space-y-3">
                                        {banks.map(({ name, iconKey }) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <span style={{ color }} className="text-2xl md:text-3xl">
                                                        {icon}
                                                    </span>
                                                    <span>{name}</span>
                                                </li>
            ...
            >
                <h2 className="text-3xl font-bold text-black mb-10 text-center">Eligibility Criteria</h2>
