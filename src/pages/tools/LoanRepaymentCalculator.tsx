// components/tools/LoanRepaymentCalculator.tsx
"use client";
...
export default function LoanRepaymentCalculator() {
   ...
   *    Effective Principal at the start of repayment = P + Accrued
   * 2) Repayment period: EMI over tenureYears with monthly compounding
  ...
  const calculate = () => {
    ...
    const totalPay = P + totalInt; // overall cost relative to original principal
  ...
  return (
    ...
    <div className="bg-gradient-to-b from-[#002855] to-[#1a1a1a] min-h-screen">
      <ToolPageTemplate
        ...
        description="Estimate EMI and total interest by including course-period accrual and repayment tenure."
