...
const TrustedByCard = ({ icon: Icon, label, labelCount = 0 }: TrustedByItem) => {
                ...
                <div className="w-full max-w-[1400px] mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold mb-4">
                            Required Documents for <br />{heroTitle} Education Loan
                        </h2>
                        <p className="text-gray-700 leading-relaxed">
                            To ensure a smooth loan approval process, applicants must submit a set
                            of standard documents. These documents help verify academic eligibility,
                            financial stability, and identification details required by the bank or
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <p className="mt-4 text-xs text-gray-500">
                            * Requirements may vary depending on the bank and course. Our experts
                            will guide you with exact documentation and timelines.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 bg-gray-50">
                <div className="w-full max-w-[1400px] mx-auto px-4">
                    ...
                    <p className="mt-4 text-sm text-gray-500 max-w-[700px] mx-auto text-center">
                        * Terms and conditions apply. This is an indicative list and may vary
                        depending on the lender’s policies. Please confirm with your loan provider
                        before applying.
                    </p>
                </div>
            </section>
